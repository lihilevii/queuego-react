...
- **בית** - חיפוש וסינון מקומות לפי קטגוריה, זמני המתנה חיים עם עדכון Realtime; לחיצה על כרטיס מקום (או על תור פעיל) פותחת דיווח כשהמקום כבר נבחר אוטומטית
- **דיווח** - שליחת רמת עומס (נמוך / בינוני / גבוה) עם הערות + מייל אישור אוטומטי; אפשר להגיע ישירות ממסך הבית עם מקום מוכן לבחירה
